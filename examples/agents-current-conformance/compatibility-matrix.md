...
| interrupted-stream resumption, approval-gated tools, facets, and MCP | not exercised by this chat and reminder slice | unsupported | follow-up tickets must add public-boundary evidence before support is claimed |
