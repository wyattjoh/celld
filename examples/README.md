...
- `agents-current-conformance/` — deterministic, credential-free current
  ...
  routing, multi-event model streaming, deterministic disconnect/concurrent
  resume into one durable assistant message, bounded terminal outcomes,
  schema-validated memory and alarm-backed reminder tools, synchronized
  completion broadcasts, and state/SQL persistence after inactivity and reconnect
